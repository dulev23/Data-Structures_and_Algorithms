...
public class ZigZag {
    ...
    public static void makeZigZag(SLL<Integer> list) {
        ...
        while (current != null) {
            ...
            if (current.element > 0 && current.succ != null && current.succ.element > 0) {
                list.delete(current.succ);
            } else if (current.element < 0 && current.succ != null && current.succ.element < 0) {
                list.insertAfter(Math.abs(current.element), current);
            }
